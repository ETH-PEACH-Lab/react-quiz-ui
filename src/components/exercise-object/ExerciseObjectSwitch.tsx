...
ExerciseComponentRegistry.registerExerciseComponent('text-response-exercise', TextResponseComponent)
ExerciseComponentRegistry.registerExerciseComponent('multiple-choice-exercise', MultipleChoiceComponent)
ExerciseComponentRegistry.registerExerciseComponent('coding-exercise', CodingComponent)

const ExerciseObjectSwitch: React.FC<Required<ExerciseProps<IExerciseObject, IExerciseAnswer>>> =
(props: Required<ExerciseProps<IExerciseObject, IExerciseAnswer>>) => {
  const ExerciseComponent = ExerciseComponentRegistry.getExerciseComponent(props.exerciseObject.type)
