...
const Template = {
  ...
  render: (args) => {
    const items: IMultipleChoiceItem[] = Array.from(Array(args.itemsCount).keys()).map(n => {
      return {
        id: 'mc-item-' + n,
    ...
    return <MultipleChoiceComponent {...args} exerciseObject={{ ...args.exerciseObject, items }}/>
  },
  argTypes: {
